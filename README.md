...
- [Buy components](doc/wiki/materials.md)  
- [Flashing NRF52](doc/wiki/flashing.md)  
- [Assembly](doc/wiki/assembly.md)  

# Project Files

| Description | Location |
|-------------|----------|
| EasyEDA source files | `/hardware/pcb/sources` |
| Board outline vectors | `/hardware/pcb/vectors` |
| Gerber files | `/hardware/pcb/gerber` |
| Meshtastic configuration | `/firmware/configuration` |
| 3D design source files | `/hardware/case/sources` |
| STL / 3MF printable files | `/hardware/case/printables` |

---

# License

This project is open hardware and open source. Feel free to study, modify, manufacture, and improve it.